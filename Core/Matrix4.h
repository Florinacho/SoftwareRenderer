...
public:
	...
	Matrix4<T> operator * (const Matrix4<T>& other) const {
		Matrix4<T> ans;
		ans.m[ 0] = m[ 0] * other[ 0] + m[ 4] * other[ 1] + m[ 8] * other[ 2] + m[12] * other[ 3];
		ans.m[ 1] = m[ 1] * other[ 0] + m[ 5] * other[ 1] + m[ 9] * other[ 2] + m[13] * other[ 3];
		ans.m[ 2] = m[ 2] * other[ 0] + m[ 6] * other[ 1] + m[10] * other[ 2] + m[14] * other[ 3];
		ans.m[ 3] = m[ 3] * other[ 0] + m[ 7] * other[ 1] + m[11] * other[ 2] + m[15] * other[ 3];
		ans.m[ 4] = m[ 0] * other[ 4] + m[ 4] * other[ 5] + m[ 8] * other[ 6] + m[12] * other[ 7];
		ans.m[ 5] = m[ 1] * other[ 4] + m[ 5] * other[ 5] + m[ 9] * other[ 6] + m[13] * other[ 7];
		ans.m[ 6] = m[ 2] * other[ 4] + m[ 6] * other[ 5] + m[10] * other[ 6] + m[14] * other[ 7];
		ans.m[ 7] = m[ 3] * other[ 4] + m[ 7] * other[ 5] + m[11] * other[ 6] + m[15] * other[ 7];
		ans.m[ 8] = m[ 0] * other[ 8] + m[ 4] * other[ 9] + m[ 8] * other[10] + m[12] * other[11];
		ans.m[ 9] = m[ 1] * other[ 8] + m[ 5] * other[ 9] + m[ 9] * other[10] + m[13] * other[11];
		ans.m[10] = m[ 2] * other[ 8] + m[ 6] * other[ 9] + m[10] * other[10] + m[14] * other[11];
		ans.m[11] = m[ 3] * other[ 8] + m[ 7] * other[ 9] + m[11] * other[10] + m[15] * other[11];
		ans.m[12] = m[ 0] * other[12] + m[ 4] * other[13] + m[ 8] * other[14] + m[12] * other[15];
		ans.m[13] = m[ 1] * other[12] + m[ 5] * other[13] + m[ 9] * other[14] + m[13] * other[15];
		ans.m[14] = m[ 2] * other[12] + m[ 6] * other[13] + m[10] * other[14] + m[14] * other[15];
		ans.m[15] = m[ 3] * other[12] + m[ 7] * other[13] + m[11] * other[14] + m[15] * other[15];
		return ans;
	}
...
public:
	...
	Matrix3<T>(
		const T  m0, const T  m3, const T  m6,
		const T  m1, const T  m4, const T  m7,
		const T  m2, const T  m5, const T  m8) {
	...
	Matrix3<T>(const Matrix3<T>& other) {
		m[ 0] = other.m[ 0];
		m[ 1] = other.m[ 1];
		m[ 2] = other.m[ 2];
		m[ 3] = other.m[ 3];
	...
	Matrix3<T>(const Matrix4<T>& other) {
		m[ 0] = other.m[ 0];
		m[ 1] = other.m[ 1];
		m[ 2] = other.m[ 2];
		m[ 3] = other.m[ 4];
